...
class Brand extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      categoryText: 'Patagonia scores a A- in this category',
      pass: true,
      transActive: true,
      susEffActive: false,
      envImpActive: false,
  ...
  transActive() {
    this.setState({ pass: true, categoryText: 'Patagonia scores a A- in this category', transActive: true, susEffActive: false, envImpActive: false, ethLabActive: false });
  }

  susEffActive() {
    this.setState({ pass: true, categoryText: 'Patagonia is part of various efforts to adress sustainability. This can be confirmed through sustainability information provided on their website.', transActive: false, susEffActive: true, envImpActive: false, ethLabActive: false });
  }

  envImpActive() {
    this.setState({ pass: true, categoryText: 'Patagonia scores a A+ in this category', transActive: false, susEffActive: false, envImpActive: true, ethLabActive: false });
  }
